...
<img alt="Premium Insurance Shield" className="w-full h-full object-contain relative z-10 spring-bounce is-visible mix-blend-lighten" id="shield-img" src="/images/insurance-shield.png" />
</div>
