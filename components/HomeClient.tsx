...
<img alt="Premium Insurance Shield" className="w-full h-full object-contain relative z-10 spring-bounce is-visible" id="shield-img" src="/images/premium_insurance_shield.png" />
</div>
